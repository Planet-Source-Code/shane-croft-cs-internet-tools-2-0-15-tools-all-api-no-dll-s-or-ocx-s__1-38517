...
Begin VB.Form FrmSaveIpCalc 
   Caption         =   "Save IP Calculation"
   ClientHeight    =   3795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7410
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   6240
         Picture         =   "FrmSaveIpCalc.frx":0E42
         Top             =   240
         Width           =   480
      End
   End
End
Attribute VB_Name = "FrmSaveIpCalc"
...
CD1.Filename = "IP Calculation" & ".txt"
